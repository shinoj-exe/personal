...
const TGH = () => {
  return (
    <motion.div initial={{ opacity:0}}  animate={{ opacity : 1 }} transition={{ delay : 0.1}} className='w-full'>
        <h3 className='flex gap-1 font-medium text-xl font-titleFont'>TGH Technologies <span className='text-textGreen tracking-wide'> | Front End Developer Intern </span> <a target="_blank" href='../assets/TGH_Internship_Certificate.pdf' className='text-textGreen mt-1'><BsLink45Deg/></a> </h3>
