...
const CSBUDDY = () => {
  return (
    <motion.div initial={{ opacity:0}}  animate={{ opacity : 1 }} transition={{ delay : 0.1}} className='w-full'>
        <h3 className='flex flex-col mdl:flex-row gap-1 font-medium text-xl font-titleFont'>CSBUDDY <span className='text-textGreen tracking-wide flex items-center '> | Web Developer Intern <a target="_blank" href='../assets/CSBUDDY_Internship_Certificate.pdf' className='text-textGreen mt-1  inline-flex '><BsLink45Deg/></a> </span> </h3>
